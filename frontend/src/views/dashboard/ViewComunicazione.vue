...
function pubblicaComunicazione() {
    ...
    router.push({ path: '/dashboard', query: { published: 'true' } })
};
                ...
                <form class="flex flex-col justify-center items-center">
                    <label class="form-control w-full">
                        ...
                        <input v-model="title" type="text" placeholder="Riassumi in un titolo la segnalazione"
                            class="input w-full" maxlength="200" required />
                        <div class="label">
                    ...
                    <div class="columns-1 md:columns-2 w-full gap-6 mt-6">
                        ...
                        <label class="form-control w-full mt-6">
                            ...
                            <div class="join w-full join-vertical sm:join-horizontal">
                                <input v-model="startDate" type="date" class="input join-item grow">
                                <input v-model="startTime" type="time" class="input join-item grow">
                            </div>
                            <div class="label">
                    ...
                    <div class="columns-1 sm:columns-2 w-full gap-6 mt-6">
                        ...
                        <label class="form-control w-full mt-6">
                            ...
                            <div class="join w-full join-vertical xl:join-horizontal">
                                <input v-model="coordinates.lat" type="number" class="input join-item grow"
                                    placeholder="Latitudine" />
                                <input v-model="coordinates.lon" type="number" class="input join-item grow"
